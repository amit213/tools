...
curl "https://api.telegram.org/bot5171666341:AAHxHeZLgSxf-G2psi8zku0qIsxbsTldHLg/sendMessage?chat_id=628822188&text='`hostname` is up at `hostname -I | awk '{print $1}'`'";
